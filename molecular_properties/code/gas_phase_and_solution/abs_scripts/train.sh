...
task_name="e_abs"  # molecular property prediction task name 
task_num=1
...
lr_values=(0.0004)
local_batch_size_values=(4)
dropout_values=(0.2)
warmup_values=(0.06)
encoder_layers_values=(14) 
n_gpu=4


echo "Number of GPUs to be used: $n_gpu"

if [ "$task_name" == "qm7dft" ] || [ "$task_name" == "qm8dft" ] || [ "$task_name" == "qm9dft" ] || [ "$task_name" == "e_abs" ]; then
