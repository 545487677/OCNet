...
@register_model("trans_features_model")
class TransMixFeaturesModelsModel(BaseUnicoreModel):
    ...
    def __init__(self, args, mol_dictionary, pocket_dictionary):
        ...
        self.feature_head = NonLinearHead(
            input_dim=self.args.feature_num,
    ...
    def forward(
        ...
        **kwargs
        ...
        mol_padding_mask = src_tokens.eq(self.mol_model.padding_idx)
        mol_x = self.mol_model.embed_tokens(src_tokens)
        mol_graph_attn_bias = get_dist_features(src_distance, src_edge_type, 'mol')
...
@register_model_architecture("trans_features_model", "trans_features_model")
def base_model_architecture(args):
    ...
    args.mol.max_seq_len = getattr(args, "mol_max_seq_len", 2000)
    ...
    args.pocket.max_seq_len = getattr(args, "pocket_max_seq_len", 2000)
