...
@register_model("trans_features5_deepchem")
class TransMixFeatures5DeepChemModel(BaseUnicoreModel):
...
@register_model_architecture("trans_features5_deepchem", "trans_features5_deepchem")
