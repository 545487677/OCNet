...
task_name="fwhm"  # molecular property prediction task name 
task_num=1 
...
dropout_values=(0.1)
warmup_values=(0.05)
encoder_layers_values=(7) 
n_gpu=1 #4


if [ "$task_name" == "qm7dft" ] || [ "$task_name" == "qm8dft" ] || [ "$task_name" == "qm9dft" ] || [ "$task_name" == "fwhm" ]; then
