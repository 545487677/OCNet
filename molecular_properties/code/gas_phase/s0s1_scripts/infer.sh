...
weight_path='../../../weight/gas_phase/s0s1/checkpoint_best.pt'  # replace to your ckpt path
batch_size=16
task_name='s0s1' # data folder name 
...
# R2 for Column 0: 0.8034417831328965
# MAE for column 0: 0.19933696403