...
weight_path='../../../weight/gas_phase/er/checkpoint_best.pt'  # replace to your ckpt path
batch_size=16
task_name='er' # data folder name 
...
# 
# R2 for Column 0: 0.5746692273062839
# MAE for column 0: 0.08205680795189459