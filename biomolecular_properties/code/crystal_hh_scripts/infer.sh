...
weight_path='../../weight/crystal_hh/checkpoint_best.pt'  # replace to your ckpt path
batch_size=64
task_name='crystal_hh' # data folder name 
task_num=1
dict_name='dict.txt'
...
# R2 for Column 0: 0.90872171783532
# MAE for column 0: 0.0021382149344133677
# 2025-02-25 12:45:17 | INFO | unimol.inference | Done inference! 
# (87741, 3)